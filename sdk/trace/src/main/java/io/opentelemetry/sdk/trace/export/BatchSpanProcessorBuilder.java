...
public final class BatchSpanProcessorBuilder {
  ...
  public BatchSpanProcessorBuilder setMaxQueueSize(int maxQueueSize) {
    ...
    if (maxQueueSize < this.maxExportBatchSize) {
      logger.log(
          Level.WARNING,
          "maxExportBatchSize should not exceed maxQueueSize. Setting maxQueueSize to {0} while maxExportBatchSize is {1}",
          new Object[] {maxQueueSize, this.maxExportBatchSize});
    }
